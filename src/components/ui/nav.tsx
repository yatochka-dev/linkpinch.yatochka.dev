    ...
    return (
        <Paper sx={{
            ...
            <Box sx={{
                ...
                {loggedIn && <NavLink href={"/dashboard"} last icon={<FeaturedPlayListIcon/>}>
                    Dashboard
                </NavLink>}
                <Box flexGrow={.5}/>
                ...
                {loggedIn && <NavLink profile last href={"/profile"} icon={<Avatar
                    src={session.user.image ?? getDefaultAvatar()}>{session.user.name}</Avatar>}>Profile</NavLink>}
