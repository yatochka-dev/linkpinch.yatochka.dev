                ...
                <Box component={'form'} sx={{
                    ...
                    <FormDisablingTextField
                        ...
                        helperText={<Box sx={{
                            ...
                            alignItems: 'center',
                            gap: 1,
                            "--alias-checker-color": theme => pending ? theme.palette.text.secondary : aliasIsOk ? theme.palette.success.main : theme.palette.error.main
                        }} component={'span'}>
                            <span>
                                If you {"don't"} provide a custom alias, one will be generated for you.
                            </span>
                            <Box sx={{
                                flexGrow: 1
                            }} component={'span'}/>
                            {!!alias && <span style={{"color": "var(--alias-checker-color)"}}>
                                 {pending ? "Checking..." : aliasIsOk ? "Alias is available" : "Alias is taken or invalid"}
                             </span>}
                        </Box>}
                    ...
                    <FormLoadingButton type={"submit"} disabled={!aliasIsOk || pending}>
                        Save
                    </FormLoadingButton>
                </Box>
